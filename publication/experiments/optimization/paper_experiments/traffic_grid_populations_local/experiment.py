...
programs = (
  ...
  { 'name': 'traffic_grid_populations/traffic_grid_populations_20x20', 'stddevs': (0.1,), 'seed': (1,), 'nreps': (1,), 'time_limit':  2 * 3600 * 1.1, 'params': partial(uniform, 0, 2, 400),   },
  { 'name': 'traffic_grid_populations/traffic_grid_populations_20x20', 'stddevs': (0.2,), 'seed': (1,), 'nreps': (1,), 'time_limit':  2 * 3600 * 1.1, 'params': partial(uniform, 0, 2, 400),   },
  { 'name': 'traffic_grid_populations/traffic_grid_populations_20x20', 'stddevs': (0.4,), 'seed': (1,), 'nreps': (1,), 'time_limit':  2 * 3600 * 1.1, 'params': partial(uniform, 0, 2, 400),   },
)
